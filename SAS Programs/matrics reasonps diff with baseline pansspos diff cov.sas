...
data multidata ;
  set schizchina;
  keep SubNo2 groupcd PANNSPosFactW12W2DIFF PANNSPosFactW24W2DIFF MATRICSREASONPSW12W2DIFF MATRICSREASONPSW24W2DIFF W2MCCBReasoningandProblem;  
  run;
...
proc mixed data=unidata method=ml covtest;
  ...
  model reasonpsdiff=  W2MCCBReasoningandProblem PANNSPosFactW12W2DIFF groupcd time  time*groupcd /solution;
  ...
  title 'repeated measures  matrics reasoningps diff baseline with pansspos5fact w12w2diff cov '; 
run;

****** Model1 -- Unstructured matrics reasoningps  diff  ,  **********;
proc mixed data=unidata method=ml covtest;
  class  SubNo2 groupcd time ;
  model reasonpsdiff=  W2MCCBReasoningandProblem PANNSPosFactW24W2DIFF groupcd time  time*groupcd /solution;
  repeated time /subject=SubNo2 type=un r rcorr;
  lsmeans time*groupcd/diffs;
  ods output diffs=groupcdiffs lsmeans=groupcdlsmeans;
  title 'repeated measures  matrics reasoningps diff baseline with pansspos5fact w24w2diff cov '; 
run;
