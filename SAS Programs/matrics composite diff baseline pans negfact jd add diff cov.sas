...
data multidata ;
  set schizchina;
  keep SubNo2 groupcd matricsovcompsitew2 PANNSNegFactJDaddW12W2DIFF PANNSNegFactJDaddW24W2DIFF MATRICSCOMPOSITEW12W2DIFF MATRICSCOMPOSITEW24W2DIFF  ;  
...
proc mixed data=unidata method=ml covtest;
  ...
  model matricsovcompdiff= matricsovcompsitew2 PANNSNegFactJDaddW12W2DIFF groupcd time  time*groupcd/solution;
  ...
  title 'repeated measures matrics overall composite diff with baseline and panssneg5fact JD add diff cov'; 
run;

****** Model1 -- Unstructured matrics overall comp unstructured model  **********;
proc mixed data=unidata method=ml covtest;
  class SubNo2 groupcd time;
  model matricsovcompdiff= matricsovcompsitew2 PANNSNegFactJDaddW24W2DIFF groupcd time  time*groupcd/solution;
  repeated time /subject=SubNo2 type=un r rcorr;
  lsmeans time*groupcd/diffs;
  ods output diffs=groupcdiffs lsmeans=groupcdlsmeans;
  title 'repeated measures matrics overall composite diff with baseline and panssneg5fact JD add diff cov'; 
