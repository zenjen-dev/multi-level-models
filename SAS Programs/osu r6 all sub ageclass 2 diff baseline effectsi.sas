...
TITLE1 "repeated measures osu total diff age class unstructured model baseline cov";
...
run;
%mend;
%effectsize_rep(file=unidata,y=osutotavdiff,class= SUBNUM DRUGCODEN time, fixed = Baselineaverage DRUGCODEN time  ageclass2 time*DRUGCODEN ageclass2*DRUGCODEN ageclass2*time*DRUGCODEN);
