PROC IMPORT OUT= WORK.autismchina 
 /* change file name here*/ DATAFILE= "C:\Users\jenarriaza\SAS Files\Data\osu r8 dis below 60 rev2.sav"
...
TITLE1 "repeated measures osu r8 dis below 60 total av diff  unstructured model";
