PROC IMPORT OUT= WORK.autismchina 
 /*change file location here*/ DATAFILE= "C:\Users\jenarriaza\SAS Files\Data\RBS  r4 60iq_ageclass.sav"
...
proc mixed data=unidata method=ml covtest;
  ...
  title 'repeated measuresop rbs over60 self injurous behavior diff  unstructured model baseline  cov'; 
run;
