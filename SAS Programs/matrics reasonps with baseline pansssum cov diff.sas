...
data multidata ;
  set schizchina;
  keep SubNo2 groupcd W12PANSSSUMdiff W24PANSSSUMdiff MATRICSREASONPSW12W2DIFF MATRICSREASONPSW24W2DIFF W2MCCBReasoningandProblem;  
  run;
...
proc mixed data=unidata method=ml covtest;
  ...
  model reasonpsdiff=  W2MCCBReasoningandProblem W12PANSSSUMdiff groupcd time  time*groupcd /solution;
  ...
  title 'repeated measures  matrics reasoningps diff baseline with pansssum w12w2 diff cov '; 
run;

****** Model1 -- Unstructured matrics reasoningps  diff  ,  **********;
proc mixed  data=unidata method=ml covtest;
class SubNo2 groupcd time;
model reasonpsdiff= W2MCCBReasoningandProblem W24PANSSSUMdiff groupcd time time*groupcd/solution;
repeated time/subject=SubNo2 type=un r rcorr;
lsmeans time*groupcd/diffs;
ods output diffs=groupcdiffs lsmeans=groupcdlsmeans;
title 'repeated measures matrics reasoningps diff baseline with pansssum w24w2 diff cov';
run;
