...
PROC IMPORT OUT= WORK.autismchina 
 /*change file location here*/ DATAFILE= "C:\Users\jenarriaza\SAS Files\Data\revs\ABC below60 r1.sav"
...
proc mixed data=unidata method=ml covtest;
  ...
  title 'repeated measures abc dis below60 total diff unstructured model ageclass2 with baseline cov'; 
run;
