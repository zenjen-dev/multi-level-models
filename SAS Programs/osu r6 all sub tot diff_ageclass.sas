...
PROC IMPORT OUT= WORK.autismchina 
 /*change file location here*/ DATAFILE= "C:\Users\jenarriaza\SAS Files\Data\revs\OSU r6 all sub_rev.sav"
...
proc mixed data=unidata method=ml covtest;
  ...
  title 'repeated measureso osu unstructured model baseline cov and ageclass'; 
run;
